            ...
            <Container maxWidth="lg">
                ...
                <div className="equipo-descripcion">
                    <div className="descripcion-item">
                        ...
                        <img src="imagen-mision.jpg" alt="Misión" className="descripcion-imagen" />
                    </div>
                    <div className="descripcion-item2">
                        ...
                        <img src="imagen-vision.jpg" alt="Visión" className="descripcion-imagen" />
                    </div>
                    <div className="descripcion-item">
                        <div>
                            <Typography variant="h5" gutterBottom>
                        ...
                        <img src="imagen-estadisticas.jpg" alt="Estadísticas" className="descripcion-imagen" />
                    </div>
                </div>
